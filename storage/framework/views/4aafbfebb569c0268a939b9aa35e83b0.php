...
<body>
    ...
    <br>
    <a href="<?php echo e(route('vuelos.agregar')); ?>" class="btn btn-success">Agregar Nuevo</a>
    <br>
    <table class="table">
        <thead>
            <tr>
        ...
        <tbody>
            <?php $__currentLoopData = $vuelos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vuelo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo e(route('vuelos.editar', $vuelo->numeroVuelo)); ?>">Editar</a>
                    </td>
                    <td>
                        <a href="<?php echo e(route('vuelos.eliminar', $vuelo->numeroVuelo)); ?>">Eliminar</a>
                    </td>
                    <td>
                        <a>Agregar Asiento</a>
                    </td>
...
</html><?php /**PATH C:\wamp64\www\examenBryan\resources\views/vuelos.blade.php ENDPATH**/ ?>